...
app = Flask(__name__)
CORS(app, supports_credentials=True, origins="https://hestia-secrect-area-vercel.vercel.app")
...
def login():
    ...
    try:
        ...
        response = requests.get(f'https://hestia-api-postgres-prod.onrender.com/advertiser/profile/{email}')
